...
const features = [
  {
    ...
    description: "Your medical data is encrypted and accessible only to authorized users.",
  },
  {
      ...
      <section className="min-h-screen flex flex-col items-center text-center px-6 bg-background text-text relative pt-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-primary mb-8">
            HealSync brings your entire health story together. A modern medical records
            platform that lets you and your doctor stay in sync—securely, effortlessly, and
            always up to date.
          </p>
          <Link to="/signup" className="relative group px-6 py-3 rounded-lg overflow-hidden transition-transform duration-300 ease-in-out
      ...
      <section className="py-20 px-6 text-center bg-background">
        ...
        >
          ...
          <p className="text-secondary mb-8">
            Sign up and experience the future of digital healthcare with HealSync.
          </p>
          <Link to="/signup" className="bg-accent text-white px-8 py-3 rounded-xl font-semibold text-lg hover:scale-105 transition-all">
            Create Your Account
          </Link>
        </motion.div>
      </section>
