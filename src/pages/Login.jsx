        ...
        >
          ...
          <div className="relative z-10 mb-8">
            <div className="relative">
              ...
              <div className="w-48 h-48 bg-primary rounded-3xl flex items-center justify-center shadow-2xl transform rotate-6">
          ...
          <div className="w-full max-w-md my-auto">
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-secondary mt-2">Choose your account type and login</p>
              </div>
