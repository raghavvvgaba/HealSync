...
const InputField = ({ label, type = "text", value, onChange, placeholder, className = "", error = false }) => (
  ...
  <div className="space-y-8">
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
      <InputField
        ...
        onChange={e => onBasicChange('fullName', e.target.value)}
      ...
      <InputField
        ...
        type="date"
        value={basicData?.dob || ''}
        onChange={e => onBasicChange('dob', e.target.value)}
      />
      ...
      <div>
        ...
        <Listbox
          ...
          onChange={val => onBasicChange('gender', val)}
        >
      ...
      <div>
        ...
        <Listbox
          ...
          onChange={val => onBasicChange('bloodGroup', val)}
        >
          <div className="relative">
            <Listbox.Button className={`w-full rounded-xl border-2 bg-white dark:bg-gray-800 px-4 py-3 text-left shadow-sm focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 text-sm font-medium transition-all duration-200 border-gray-200 dark:border-gray-700`}>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            onChange={e => onNestedChange('basic', 'height', 'value', e.target.value)}
            placeholder="170"
            className={`${inputClassName()} flex-1`}
          />
          <select
            value={basicData?.height?.unit || 'cm'}
            onChange={e => onNestedChange('basic', 'height', 'unit', e.target.value)}
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            onChange={e => onNestedChange('basic', 'weight', 'value', e.target.value)}
            placeholder="70"
            className={`${inputClassName()} flex-1`}
          />
          <select
            value={basicData?.weight?.unit || 'kg'}
            onChange={e => onNestedChange('basic', 'weight', 'unit', e.target.value)}
            className="rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 text-sm font-medium w-20"
          >
      ...
      <InputField
        ...
        onChange={e => onBasicChange('contactNumber', e.target.value)}
  ...
  <div className="space-y-8">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <InputField
        ...
        onChange={e => onNestedChange('basic', 'emergencyContact', 'name', e.target.value)}
      ...
      <InputField
        ...
        onChange={e => onNestedChange('basic', 'emergencyContact', 'number', e.target.value)}
      ...
      <InputField
        ...
        onChange={e => onNestedChange('basic', 'emergencyContact', 'relation', e.target.value)}
...
const MedicalInformationStep = React.memo(({ medicalData, onMultiSelectToggle, onNestedChange, setProfileData }) => (
  <div className="space-y-8">
    <MultiSelectField
      ...
      onToggle={value => onMultiSelectToggle('medical', 'chronicConditions', value)}
    />
    ...
    <MultiSelectField
      ...
      onToggle={value => onMultiSelectToggle('medical', 'allergies', value)}
    />
    ...
    <MultiSelectField
      ...
      onToggle={value => onMultiSelectToggle('medical', 'currentMedications', value)}
    />
    ...
    <MultiSelectField
      ...
      onToggle={value => onMultiSelectToggle('medical', 'disabilities', value)}
    />
      ...
      <div className="space-y-4">
        ...
        <label className="flex items-center space-x-3">
          <input
            ...
            onChange={e => onNestedChange('medical', 'vision', 'wearsGlasses', e.target.checked)}
        ...
        {medicalData?.vision?.wearsGlasses && (
          <div className="grid grid-cols-2 gap-4 mt-4">
            <InputField
              ...
              onChange={e => onNestedChange('medical', 'vision', 'leftEye', e.target.value)}
              placeholder="e.g., -2.5"
            />
            <InputField
              label="Right Eye"
              value={medicalData?.vision?.rightEye || ''}
              onChange={e => onNestedChange('medical', 'vision', 'rightEye', e.target.value)}
              placeholder="e.g., -3.0"
            />
          </div>
        )}
...
const LifestyleStep = React.memo(({ lifestyleData, onMultiSelectToggle }) => (
  <div className="space-y-8">
    <MultiSelectField
      ...
      onToggle={value => onMultiSelectToggle('lifestyle', 'habits', value)}
    />
    ...
    <MultiSelectField
      ...
      onToggle={value => onMultiSelectToggle('lifestyle', 'preferences', value)}
    />
  </div>
));
